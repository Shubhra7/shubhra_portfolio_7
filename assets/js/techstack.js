...
const techStack = [
  ...
  },
  {
    ...
    langName:"JAVA",
    langDesc:"<li>Java is a high-level, object-oriented programming language designed to have minimal implementation dependencies, allowing compiled Java code to run on any platform with a Java Virtual Machine (JVM). Its syntax is similar to C and C++, with fewer low-level facilities.</li>"
  },
];
